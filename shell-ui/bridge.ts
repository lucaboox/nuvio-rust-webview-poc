/**
 * The bridge to the Rust shell, as this shell's own file.
 *
 * Lifted out of `ui/` so that nothing the desktop client needs still lives in
 * the UI it replaced. The envelope types come with it — three small shapes —
 * rather than the 563-line file they were declared in, since carrying that
 * across to reach them would defeat the point of leaving it behind.
 */
